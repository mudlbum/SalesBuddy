        ...
        <div class="space-y-8">
            ...
            <div class="bg-white p-4 rounded-lg shadow">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button class="text-sm bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600">Add New Employee</button>
                </div>
            ...
            <div class="bg-white p-4 rounded-lg shadow">
                <div class="flex justify-between items-center mb-4">
                     ...
                     <div>
                        <button class="text-sm bg-gray-200 text-gray-800 py-2 px-4 rounded-lg hover:bg-gray-300">Time Off Requests (2)</button>
                        <button class="text-sm bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600">Publish Schedule</button>
                     </div>
                </div>
